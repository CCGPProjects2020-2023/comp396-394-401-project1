 ...
 * 
    ...
    Revision History:       October 28, 2023: Initial script and documentation.
                            ...
                            December 13, 2023 (Marcus Ngooi): Added different health levels based on game difficulty.
 */
...
public abstract class EnemyController : MonoBehaviour
{
    ...
    [Header("Game Difficulty Properties")]
    public float easyHealth = 100f;
    public float mediumHealth = 200f;
    public float hardHealth = 300f;
    ...
    { //
        ...
        // Adjust enemy health based on game difficulty
        switch (GameDifficultyManager.Instance.CurrentGameDifficulty)
        {
            case GameDifficulty.EASY: health = easyHealth; break;
            case GameDifficulty.MEDIUM: health = mediumHealth; break;
            case GameDifficulty.HARD: health = hardHealth; break;
        }
